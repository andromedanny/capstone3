                  ...
                  <div className="space-y-4">
                    ...
                    {store?.domainName && (() => {
                      ...
                      const shareToTwitter = () => {
                        const twitterUrl = `https://twitter.com/intent/tweet?url=${encodeURIComponent(websiteUrl)}&text=${encodeURIComponent(shareTitle)}`;
                        window.open(twitterUrl, 'twitter-share-dialog', 'width=626,height=436');
                      };
                      
                      const shareToWhatsApp = () => {
                        const whatsappUrl = `https://wa.me/?text=${encodeURIComponent(`${shareTitle} - ${websiteUrl}`)}`;
                        ...
                        <div className="mt-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 px-4 py-2 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#1a91da] transition-all text-sm font-medium shadow-sm"
                            >
                              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 px-4 py-2 bg-[#25D366] text-white rounded-lg hover:bg-[#22C55E] transition-all text-sm font-medium shadow-sm"
                            >
                              <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
