              ...
              <div className="flex space-x-4 flex-wrap gap-2">
                ...
                {store && store.status && (store.status.toLowerCase() === 'published') && getWebsiteUrl() && (
                  <div className="relative">
                    <button
                      onClick={() => {
                        // Open a modal or dropdown with social sharing options
                      ...
                      className="px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-lg hover:from-purple-700 hover:to-blue-700 font-medium flex items-center gap-2"
